...
# Loaded from the .env file via python-decouple. Never commit .env to version control.
SECRET_KEY = config('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=False, cast=bool)

# Comma-separated list of hostnames that the site will serve.
# In development, 127.0.0.1 and localhost are sufficient.
